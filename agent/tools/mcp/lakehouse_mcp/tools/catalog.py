...
from agent.tools.mcp.lakehouse_mcp.clients.iceberg import get_table, get_catalog

logger = logging.getLogger(__name__)

def query_bronze_audit(limit: int = 10, fecha_vigencia: Optional[str] = None) -> List[Dict[str, Any]]:
    try:
...
def query_silver_audit(limit: int = 10, fecha_vigencia: Optional[str] = None) -> List[Dict[str, Any]]:
    try:
