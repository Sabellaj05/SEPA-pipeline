import logging
import duckdb
from agent.tools.mcp.lakehouse_mcp.config import config
from agent.tools.mcp.lakehouse_mcp.clients.iceberg import get_catalog
    ...
    try:
        ...
        for table_identifier in tables:
            ...
            try:
                ...
                logger.warning(f"Could not register view for {table_name} (likely no parquet files exist yet): {ve}")
